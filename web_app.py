                ...
                <div class="col-4">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="w-100 btn btn-lg btn-outline-light btn btn-success">Купить
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div class="row mt-5">
            <div class="col-12">
                <div class="container">
                    <header>
                        <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                            <!--            <h4 class="my-0 fw-normal form-control">FAQ</h4>-->
                            <h5 class="display-6 fw-normal text-body-emphasis">Часто задаваемые вопросы</h5>
                        </div>
                    </header>
                    <div class="d-grid gap-4 col-8 mx-auto">
                        <p class="d-inline-flex gap-4">
                            <button class="btn btn-primary mr-8" style="width: 250px;" type="button"
                            ...
                            <button class="btn btn-primary mr-8" style="width: 250px;" type="button"
                                    ...
                                    aria-expanded="false" aria-controls="multiCollapseExample2">Как доставить?
                            </button>
                            <button class="btn btn-primary" style="width: 250px;" type="button"
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="collapse multi-collapse" id="multiCollapseExample3">
                                <div class="card card-body">
                                    Код для получения заказа хранится в вашем личном кабинете. Доступ к нему есть только
                                    у вас.
                                </div>
                            </div>
                        </div>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td>2500</td>
                            <td>
                                <div class="alert alert-danger" role="alert">отменён</div>
                            </td>
                        </tr>
                        </tbody>
                    </table>
